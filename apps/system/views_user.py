...
from apps.system.forms import UserCreateForm
from apps.system.models import Structure, Role
from django.shortcuts import get_object_or_404
from django.db.models import Q
from apps.system.forms import UserUpdateForm
...
class LoginView(View):
    ...
    def post(self, request):
        redirect_to = request.GET.get('next', '/')  # /login/?next=/ 表示登录后跳转到 / 下面
...
class UserListView(LoginRequiredMixin, View):
    def get(self, request):
        fields = ['id', 'name', 'gender', 'mobile', 'email', 'department__name', \
                  'post', 'superior__name', 'is_active']
        filters = dict()
