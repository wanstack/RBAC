...
from apps.system.models import Structure
from apps.system.forms import StructureForm
...
class StructureCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        # 如果 request.POST中包含id则查找该实例，并传递给ModelForm关键字参数instance，通过调用save()方法，
        # 将修改信息保存到该实例。
